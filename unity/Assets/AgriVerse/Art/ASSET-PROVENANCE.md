...
Each package was copied from its creator-supplied delivery folder into the listed `Source/`
...
| Asset ID | Use | Delivery package label | Source FBX SHA-256 |
|---|---|---|---|
...
| `ENV-WOVEN-BASKET-01` | Field dressing | `giỏ đan tre 3d model` | `010fc900240a2918f4bf7cb2319c3867fe0885d51d162aea4071e137e39a0f0a` |
...
The globe bundle was delivered as `AgriVerse_Globe_Assets` and is preserved byte-for-byte
at `Globe/Source/`. It is not a Tripo or CC0 bundle. Its original `SOURCE_AND_LICENSE.md`,
